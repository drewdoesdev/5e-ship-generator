<template>
  <div class="stats">
      <div class="stats__content">
          ...
          <div class="stats__fieldRow shipName">
              <div class="stats__fieldWrapper">
                <label for="name">Ship Name</label>
                <input class="stats__nameField" name="name" type="text" placeholder="The Salty Mistress, etc." v-model="name" />
              </div>
              <div class="stats__randomName">
          ...
          <div class="stats__fieldRow shipType">
              <div class="stats__fieldWrapper type">
                <label for="type">Type</label>
                <input class="stats__typeField" name="type" type="text" placeholder="Sailing Ship, Spelljammer, etc." v-model="type" />
              </div>
              <div class="stats__fieldWrapper size">
                <label for="size">Size</label>
                <select name="size" class="stats__sizeField">
                    <option>Tiny</option>
                    <option>Small</option>
              ...
              <div class="stats__fieldWrapper speed">
                <label for="speed">Speed</label>
                <input class="stats__speedField" name="speed" type="text" placeholder="The Salty Mistress, etc." v-model="type" />
              </div>
          </div>
      </div>
  </div>
